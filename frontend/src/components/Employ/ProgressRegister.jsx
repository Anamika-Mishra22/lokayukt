...
const ProgressRegister = () => {
    ...
    try {
      ...
      const wsData = [
        ...
        ...filteredMovements.map((movement, index) => [
          index + 1,
          movement.complaintNo || "उपलब्ध नहीं",
          movement.complainant || "उपलब्ध नहीं",
          movement.fromRole || "उपलब्ध नहीं",
          movement.toRole || "उपलब्ध नहीं",
          movement.note || "उपलब्ध नहीं",
          movement.timestamp || "उपलब्ध नहीं",
          movement.displayStatus || "उपलब्ध नहीं",
        ]),
      ];
    ...
    try {
      ...
      const wsData = [
        ...
        ...filteredStatus.map((status, index) => [
          index + 1,
          status.complaintNo || "उपलब्ध नहीं",
          status.complainant || "उपलब्ध नहीं",
          status.subject || "उपलब्ध नहीं",
          status.currentStage || "उपलब्ध नहीं",
          status.assignedTo || "उपलब्ध नहीं",
          status.receivedDate || "उपलब्ध नहीं",
          status.targetDate || "उपलब्ध नहीं",
          status.daysElapsed || "उपलब्ध नहीं",
          getStatusText(status.status) || "उपलब्ध नहीं",
        ]),
      ];
  ...
  useEffect(() => {
    const fetchComplaints = async () => {
      ...
      try {
        const response = await api.get("/admin/progress-register");
  ...
  useEffect(() => {
    const fetchCurrentReport = async () => {
      ...
      try {
        const response = await api.get("/admin/current-report");
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      ...
      try {
        const response = await api.get("/admin/analytic-report");
  ...
  const transformToFileMovements = (data) => {
    return data.map((complaint, index) => {
      ...
      return {
        ...
        note: complaint.remarks || "उपलब्ध नहीं",
        timestamp: formatDate(complaint.created_at),
        status: complaint.status || "उपलब्ध नहीं",
        isOverdue: isOverdue, 
  ...
  const transformCurrentReportToStatus = (data) => {
    ...
    return data.map((report) => {
      ...
      return {
        complaintNo: report.complain_no || "उपलब्ध नहीं",
        complainant: report.name || "उपलब्ध नहीं",
        subject: report.description || report.title || "No subject provided",
        currentStage: report.status || "उपलब्ध नहीं",
  ...
  const getTargetDate = (createdDate) => {
    if (!createdDate) return "उपलब्ध नहीं";
    try {
