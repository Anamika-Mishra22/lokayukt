...
// 🔥 NEW LOGIC
if (actionType === "summons") {
  payload.summon_date = actionDate;
}

if (actionType === "interrogation") {
  payload.interro_date = actionDate;
}

const res = await api.post(`/ps/forward-complain-by-ps/${complaintId}`, payload);
      return res.data;
    },
    onSuccess: (data) => {
  ...
  const handleConfirmYes = () => {
    ...
    // if (!actionType) {
    //   toast.error("Select action type");
    //   return;
    // }
  ...
  {isPending ? "Rejecting..." : "Reject"}
      ...
      {confirmConfig.open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-5 relative max-h-[90vh] overflow-y-auto">
            {/* Close Button */}
            <button
            ...
            {confirmConfig.type === "forward" && (
              <>
                ...
                <div className="mb-4 animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  {/* 🔥 NEW: Action Type Dropdown */}
<div className="mb-4 ">
  <label className="block mt-2 text-sm font-medium text-gray-700 mb-2">
    Select Summons/ Interrogation
  </label>
...
{actionType && (
  <div className="mb-4">
    <label className="block text-sm font-medium text-gray-700 mb-2">
      {actionType === "summons" ? "Summons Date" : "Interrogation Date"}
    </label>
