            ...
            <div>
              ...
              {isLoadingOptions ? (
                <div className="w-full p-2 border rounded-md bg-gray-50 flex items-center justify-center">
                  ...
                  <span className="text-gray-700 text-md font-semibold">Loading...</span>
                </div>
              ) : (
        ...
        {isLoading ? (
          <div className="flex justify-center items-center py-12">
            <div className="flex flex-col items-center space-y-4">
              {/* <FaSpinner className="w-12 h-12 animate-spin text-[#123463]" /> */}
            ...
            {currentData.length === 0 && (
              <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
                <div className="flex flex-col items-center space-y-3">
                  <FaUsers className="w-16 h-16 text-gray-300" />
                  ...
                  <p className="text-gray-400 text-sm">
                    {activeTab === 'pending' 
                      ...
                      : activeTab === 'approved'
                      ? 'No approved complaints at this time'
