...
const AllRtiFile = () => {
  ...
  const getAllFiles = async () => {
    const res = await api.get("/supervisor/get-user-rti-details");
    return res.data;
  };
...
<p className="text-sm text-gray-600">सभी अपील एवं आरटीआई फाइलें</p>
    </div>
  </div>
...
{/*                     
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        onClick={() => navigate(`/employee/all-rti-file/${row.id}`)}
