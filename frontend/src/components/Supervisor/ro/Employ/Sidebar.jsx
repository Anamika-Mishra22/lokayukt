...
{/* <Link
          ...
          >
            ...
            {(!isCollapsed || isMobile) && "Pending Personal Files"}
                ...
                <Link
                to="/employee/all-rti-file"
                onClick={handleLinkClick}
                className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition
                  ${
                    location.pathname.includes("/employee/all-rti-file") ||
                    location.pathname.includes("/employee/add-rti-file")
                      ? "bg-blue-600 text-white shadow-md"
                      : "text-gray-700 hover:bg-gray-200"
                  }
                  ${isCollapsed && !isMobile ? "justify-center" : ""}
              ...
              >
                ...
                {(!isCollapsed || isMobile) && "Appeal and RTI Files"}
                                                                ...
                                                                <Link
                                                                  to="/employee/leave-file-approved"
                                                                  onClick={handleLinkClick}
