...
const AllLeaveFiles = () => {
  ...
  const getAllFiles = async () => {
    const res = await api.get("/supervisor/get-leave-personal-details");
    return res.data;
  };
 ...
 onError: (err) => {
  ...
  <div className="w-full md:w-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
    ...
    <button
            onClick={() => navigate("/administrative/add-personal-file")}
...
>
  Permissions
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        onClick={() => navigate(`/administrative/all-personal-file/${row.id}`)}
