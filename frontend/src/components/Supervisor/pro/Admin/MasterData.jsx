    ...
    try {
      ...
      switch (activeTab) {
        ...
        case 'departments':
          ...
          break;
        case 'subjects':
          endpoint = `/supervisor/edit-subject/${editingItem.id}`;
    ...
    try {
      ...
      switch (activeTab) {
        ...
        case 'departments':
          ...
          break;
        case 'subjects':
          endpoint = `/supervisor/add-subject`;
          requestData = { name: formData.name, name_h: formData.name };
          break;
        case 'designations':
...
const MasterData = () => {
  ...
  const fetchMasterData = async (tab) => {
    ...
    switch (tab) {
      ...
      case 'subjects': endpoint = '/supervisor/subjects'; break;
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      switch (activeTab) {
        ...
        case 'subjects': endpoint = `/supervisor/delete-subject/${deletingItem.id}`; break;
