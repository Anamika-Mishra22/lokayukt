...
const AllLeaveFiles = () => {
  ...
  const getAllFiles = async () => {
    const res = await api.get("/lokayukt/get-leave-details");
    return res.data;
  };
  ...
  const updateLeaveStatus = async ({ id, status }) => {
    const res = await api.post(`/lokayukt/change-employee-status/${id}`, { status });
    return res.data;
  };
  ...
  const handleViewFile = async (fileId) => {
    try {
      ...
      const res = await api.get(`/lokayukt/get-file-pdf/${fileId}`);
