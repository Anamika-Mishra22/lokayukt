...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
  ...
  <div>
    ...
    <p className="text-xs md:text-sm text-gray-600 mt-3">
      Name: {complaintData.permanent_name || "उपलब्ध नहीं"}
    </p>

    <p className="text-xs md:text-sm text-gray-600 mt-1">
    Address: {complaintData.permanent_place || "उपलब्ध नहीं"}
    </p>

    {complaintData.email && (
      <p className="text-xs md:text-sm text-gray-600 mt-1">
        Email: {complaintData.email || "उपलब्ध नहीं"}
      </p>
    )}
  </div>
  ...
  <div>
    ...
    <p className=" text-gray-800 text-sm md:text-base">
      {complaintData.permanent_district || "उपलब्ध नहीं"}
    </p>
  ...
  <div>
    ...
    <p className=" text-gray-800 text-sm md:text-base">
      {complaintData.other_witnesses || "उपलब्ध नहीं"}
    </p>
    ...
    <p className=" text-gray-800 text-sm md:text-base">
      {complaintData.previously_submitted_details || "उपलब्ध नहीं"}
    </p>
