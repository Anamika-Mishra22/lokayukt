...
const ScanLetter = () => {
 ...
 const submitScaneData = async (e) => {
  ...
  payload.append("assign_no", formData.assign_no);
                ...
                {errors.medium && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.medium[0]}
                                          ...
                                          <div>
  <label className="block text-sm font-medium text-gray-700 mb-1">
  Assign No / असाइन संख्या<span className="text-red-500">*</span>
  </label>

<input
  type="number"
  name="assign_no"
  value={formData.assign_no}
  onChange={(e) => {
    const value = e.target.value;
  ...
  className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
    errors.assign_no ? "border-red-300" : "border-gray-200"
  }`}
/>
