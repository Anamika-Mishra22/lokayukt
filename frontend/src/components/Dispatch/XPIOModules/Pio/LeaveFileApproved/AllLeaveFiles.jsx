...
const AllLeaveFiles = () => {
  ...
  const getAllFiles = async () => {
    const res = await api.get("/dispatch/get-leave-details");
    return res.data;
  };
  ...
  const updateLeaveStatus = async ({ id, status }) => {
    const res = await api.post(`/dispatch/change-employee-status/${id}`, { status });
    return res.data;
  };
  ...
  const handleViewFile = async (fileId) => {
    try {
      ...
      const res = await api.get(`/dispatch/get-file-pdf/${fileId}`);
