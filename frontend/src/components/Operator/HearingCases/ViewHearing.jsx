      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className=" kruti-input text-gray-800 text-sm">
            {complaintData.main_complainant_name || "उपलब्ध नहीं"}
          </p>
        </div>
        ...
        <div>
          ...
          <p className=" kruti-input text-gray-800 text-sm">
            {complaintData.main_complainant_father || "उपलब्ध नहीं"}
          </p>
        </div>
        ...
        <div>
          ...
          <p className="kruti-input text-gray-800 text-sm">
            {complaintData.main_complainant_district || "उपलब्ध नहीं"}
          </p>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className=" kruti-input text-gray-800 text-sm">
            {complaintData.main_respondent_name || "उपलब्ध नहीं"}
          </p>
        </div>
        ...
        <div>
          ...
          <p className="kruti-input text-gray-800 text-sm">
            {complaintData.main_respondant_district || "उपलब्ध नहीं"}
          </p>
        </div>
      </div>
    </div>
