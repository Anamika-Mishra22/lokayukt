...
const subroleName = Cookies.get("subroleName")
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      if (error.response?.data?.message) {
        toast.error(typeof error.response.data.message === 'string' ? error.response.data.message : 'Logout failed.');
      } else {
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 outline-none transition-all ${
                    fieldErrors.current_password ? '' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                  }`}
              ...
              <div>
                ...
                <input
                  type="password"
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 outline-none transition-all ${
                    fieldErrors.new_password ? '' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                  }`}
              ...
              <div>
                ...
                <input
                  type="password"
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 outline-none transition-all ${
                    fieldErrors.new_password_confirmation ? '' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                  }`}
                  ...
                  onChange={(e) => {
                    ...
                    if (fieldErrors.new_password_confirmation) {
                      setFieldErrors(prev => ({ ...prev, new_password_confirmation: null }));
                    }
                  }}
                  disabled={isChangingPassword}
                />
                {fieldErrors.new_password_confirmation && (
                  <p className="text-red-500 text-xs mt-1">{fieldErrors.new_password_confirmation[0]}</p>
                )}
              </div>
            </div>
