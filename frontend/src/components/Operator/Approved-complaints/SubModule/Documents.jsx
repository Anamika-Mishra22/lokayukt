...
const Documents = ({ complaint }) => {
  ...
  const oldCmpValue = location.pathname.includes("view-old-complaint") ? 1 : 2;
  ...
  const uploadDocument = async () => {
    ...
    try {
      ...
      formData.append("old_cmp", oldCmpValue);
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                placeholder=',h"kZd tksM+sa'
                className={`border kruti-input px-3 py-2 rounded-lg w-full bg-white text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 ${
