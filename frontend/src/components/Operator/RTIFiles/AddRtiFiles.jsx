...
const AddRtiFiles = () => {
  ...
  const AllFiles = async () => {
    const res = await api.get("/operator/filetypes");
  ...
  const uploadDocument = async () => {
    ...
    try {
      ...
      await uploadApi.post("/operator/upload-rti-file", formData);
    ...
    <>
      <div className="space-y-6 w-full min-h-screen pb-10 ">
        <div className="flex items-start justify-between w-full gap-3">
          <div>
          <h1 className="text-xl font-bold text-gray-900">Add RTI File</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              >
                ...
                <option className="text-[12px]" value="RTI">आरटीआई</option>
                <option className="text-[12px]" value="APPEAL">प्रथम अपील</option>
              </select>
