...
const ViewPendingComplaint = () => {
  ...
  const handleEditNavigation = () => {
    if (id && complaintData) {
      ...
      navigate(`/operator/pending-complaints/edit/${id}`);
    } else {
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
          ...
          <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
            ...
            <button 
              onClick={() => navigate("/operator/pending-complaints")}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-md bg-gray-50">
                      {complaintData.name || "उपलब्ध नहीं"}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-md bg-gray-50 font-mono">
                      {complaintData.mobile || "उपलब्ध नहीं"}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-md bg-gray-50 min-h-[80px] whitespace-pre-wrap">
                    {complaintData.address || "उपलब्ध नहीं"}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-md bg-gray-50">
                      {complaintData.district_name || "उपलब्ध नहीं"}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-md bg-gray-50">
                      {complaintData.email || "उपलब्ध नहीं"}
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                        {complaintData.amount || "उपलब्ध नहीं"}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                        {complaintData.challan_no || "उपलब्ध नहीं"}
                      </div>
                    </div>
      ...
      No file attached
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                        ...
                        <div>
                          ...
                          <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                            {detail.department_name || "उपलब्ध नहीं"}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                            {detail.officer_name || "उपलब्ध नहीं"}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                            {detail.designation_name || "उपलब्ध नहीं"}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50 capitalize">
                            {detail.category?.replace("_", " ") || "उपलब्ध नहीं"}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div>
                          ...
                          <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                            {detail.subject_name || "उपलब्ध नहीं"}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50">
                            {detail.complaintype_name || "उपलब्ध नहीं"}
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-50 min-h-[100px] whitespace-pre-wrap">
                          {detail.description || "उपलब्ध नहीं"}
                        </div>
                      </div>
                    </div>
                  </div>
...
export default ViewPendingComplaint;
