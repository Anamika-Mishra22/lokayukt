...
const AllLeaveFiles = () => {
  ...
  const getAllFiles = async () => {
    const res = await api.get("/uplokayukt/get-leave-details");
    return res.data;
  };
  ...
  const updateLeaveStatus = async ({ id, status }) => {
    const res = await api.post(`/uplokayukt/change-employee-status/${id}`, { status });
    return res.data;
  };
  ...
  const handleViewFile = async (fileId) => {
    try {
      ...
      const res = await api.get(`/uplokayukt/get-file-pdf/${fileId}`);
