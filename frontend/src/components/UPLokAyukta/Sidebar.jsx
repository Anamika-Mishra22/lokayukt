...
const Sidebar = ({
  ...
  const isActive = (href) => {
    ...
    // Make dashboard active for exact match OR when at base /uplokayukt route
    if (href === "/dashboard") {
      return location.pathname === fullPath || location.pathname === "/uplokayukt" || location.pathname === "/uplokayukt/";
    }
                            ...
                            {isActive("/approved-complaints") && (isMobile) && (
                              <div className="w-10 h-5 bg-blue-400 rounded-full flex items-center justify-end pr-[2px]">
                                <div className="w-4 h-4 bg-white rounded-full"></div>
                                  ...
                                  <li>
                                                      <Link
                                                        to="/uplokayukt/leave-file-approved"
                                                        onClick={handleLinkClick}
                                                        className={`flex items-center justify-between text-sm  transition-all duration-200 rounded-lg ${
