  ...
  <div className="flex flex-col gap-3 text-sm text-slate-700 mt-1 pl-1">
    ...
    <p>
      ...
      <span className="mx-2 text-slate-400">—</span> 
       Complaint send back to Hon’ble Lokayukt.
    </p>
    ...
    <p>
      <span className="font-semibold text-slate-900">Sent / Mark</span> 
      <span className="mx-2 text-slate-400">—</span> 
              ...
              <div className="mb-5">
                ...
                <input
                 ...
                 onChange={(e) => {
                    ...
                    setFieldErrors({ ...fieldErrors, target_date: null }); // Error hatana
                  }}
                  className="w-full px-3 py-2 border border-gray-300 rounded
                 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors({ ...fieldErrors, otp: null }); // Error hatana
                    }}
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {complaintData.respondant.map((resp, idx) => (
                          ...
                          >
                            ...
                            <td className="px-4 c py-3 kruti-input text-sm text-gray-600 border-r border-gray-100 whitespace-nowrap">
