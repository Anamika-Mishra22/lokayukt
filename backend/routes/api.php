...
use App\Http\Controllers\api\Operator\OperatorCaseHearingController;
use App\Http\Controllers\api\Operator\OperatorLetterRecords;
...
use App\Http\Controllers\api\APS\APSComplaintsController;
use App\Http\Controllers\api\APS\APSReportController;
use App\Http\Controllers\api\APS\APSCommonController;
use App\Http\Controllers\api\APS\APSDashboardController;
use App\Http\Controllers\api\Stenographer\StenoComplaintsController;
use App\Http\Controllers\api\Stenographer\StenoReportController;
use App\Http\Controllers\api\Stenographer\StenoCommonController;
use App\Http\Controllers\api\Stenographer\StenoDashboardController;
use App\Http\Controllers\api\AssistantClirk\ACComplaintsController;
use App\Http\Controllers\api\AssistantClirk\ACReportController;
use App\Http\Controllers\api\AssistantClirk\ACCommonController;
use App\Http\Controllers\api\AssistantClirk\ACDashboardController;
...
use App\Http\Controllers\api\Supervisor\SupervisorLetterRecordsController;
...
use App\Http\Controllers\api\Dispatch\DispatchLetterRecordsController;
...
Route::middleware('auth:sanctum')->group(function () {
     // Route::get('/reset-all-password', [UserManagement::class, 'resetAllUsersPassword']);
  ...
  Route::middleware('role:admin')->prefix('admin')->group(function () {
    ...
    Route::get('/get-leave-rti-details', [CommonController::class, 'fetchLeavesRtiDetails']);

    Route::get('/get-leave-rti-details/{id}', [CommonController::class, 'fetchLeavesRtiDetailsById']);
    ...
    Route::get('/get-file-preview-employee/{id}', [EmployeesController::class, 'getFilePreview']);

    Route::post('/file/give-permission', [EmployeesController::class, 'giveFilePermission']);
    Route::post('/file/give-permission-rti', [EmployeesController::class, 'giveFilePermissionRti']);
    ...
    //  Route::get('/view-old-complaint/{id}',[AdminReportController::class,'viewOldComplaint']);
    ...
    Route::get('/rti-file-list', [EmployeesController::class, 'rtiFileList']);

    Route::get('/personal-file-list/{id}', [EmployeesController::class, 'personalFileListById']);
    Route::get('/rti-file-list/{id}', [EmployeesController::class, 'rtiFileListById']);

    Route::post('/add-notes-employee', [SupervisorComplaintsController::class, 'addNotesEmployee']);
    Route::post('/personal-file-send', [EmployeesController::class, 'sendPersonalFile']);
    Route::post('/rti-file-send', [EmployeesController::class, 'forwardRtiFile']);
    Route::get('/get-personal-notes/{id}', [SupervisorComplaintsController::class, 'getPersonalNotes']);
  ...
  Route::middleware('role:operator:record-keeper|review-operator')->prefix('operator')->group(function () {
    ...
    Route::post('/upload-private-file', [EmployeesController::class, 'uploadPrivateFiles']);
    Route::post('/upload-rti-file', [EmployeesController::class, 'uploadRTIFiles']);
    ...
    Route::post('/sent-draft-to-inbox/{complainId}', [OperatorComplaintsController::class, 'sentToInboxDraft']);
    ...
    Route::get('/all-complaints-dispatch', [OperatorComplaintsController::class, 'allComplainsDispatch']);
    ...
    Route::get('/view-old-complaint/{id}', [OperatorReportController::class, 'viewOldComplaint']);
    ...
    Route::get('/edit-complaint/{id}', [OperatorComplaintsController::class, 'edit']);
    Route::post('/update-complaint/{id}', [OperatorComplaintsController::class, 'update']);
    ...
    Route::get('/get-users-sent', [OperatorComplaintsController::class, 'getSentUsers']);
    ...
    Route::get('/search-complaints', [OperatorComplaintsController::class, 'searchComplaint']);
    Route::post('/approved-personal-file/{id}', [OperatorComplaintsController::class, 'approvedPerFileByRk']);
    Route::post('/approved-rti-file/{id}', [OperatorComplaintsController::class, 'approvedRtiByRk']);
    Route::get('/complainant-edit/{id}', [OperatorComplaintsController::class, 'editComplainant']);
    Route::post('/complainant-update/{id}', [OperatorComplaintsController::class, 'updateComplainant']);
    Route::get('/respondent-edit/{id}', [OperatorComplaintsController::class, 'editRespondant']);
    Route::post('/respondent-update/{id}', [OperatorComplaintsController::class, 'updateRespondant']);
    ...
    Route::get('/search-by-field-new-complaints', [OperatorReportController::class, 'searchNewComplaints']);
    ...
    Route::post('/request-complaints/approve', [OperatorReportController::class, 'approve']);
    Route::get('/request-complaints-badges-reset', [OperatorReportController::class, 'resetBadgeCount']);
    Route::get('/request-complaints-for-approval', [OperatorComplaintsController::class, 'fetchRequestComplaints']);
    Route::get('/request-complaints-pending', [OperatorComplaintsController::class, 'fetchRequestPendingComplaints']);
    Route::get('/request-complaints-badge', [OperatorComplaintsController::class, 'fetchRequestbadgesComplaints']);
    
    Route::post('/update-hearing-date/{id}', [OperatorCaseHearingController::class, 'updateHearingDate']);
    Route::get('/cause-list', [OperatorCaseHearingController::class, 'causeList']);
    ...
    //letter Records
    Route::get('/search-letter-record', [OperatorLetterRecords::class, 'searchLetterRecords']);
    Route::post('/upload-letter-record', [OperatorLetterRecords::class, 'uploadDocument']);
    Route::get('/get-letter-record/{id}', [OperatorLetterRecords::class, 'getUploadDoc']);
    Route::get('/view-letter-record/{id}', [OperatorLetterRecords::class, 'getLetterRecord']);
    Route::get('/all-letters', [OperatorLetterRecords::class, 'getAllLetters']);
    Route::get('/all-sent-letters', [OperatorLetterRecords::class, 'getAllSendLetters']);
    Route::post('/approved-letter-by-rk/{id}', [OperatorLetterRecords::class, 'approvedLetterByRk']);
...
//     Route::post('/add-notes-employee', [SupervisorComplaintsController::class, 'addNotesEmployee']);
    ...
    Route::get('/get-personal-notes/{id}', [SupervisorComplaintsController::class, 'getPersonalNotes']);
      ...
      Route::get('/get-leave-details', [CommonController::class, 'fetchLeavesDetails']);
    Route::post('/change-employee-status/{id}', [CommonController::class, 'approveRejectedEmployee']);
    Route::get('/get-leave-personal-details', [OperatorComplaintsController::class, 'fetchLeavesPersonalDetails']);
    Route::get('/get-leave-personal-details/{id}', [CommonController::class, 'fetchLeavesPersonalDetailsById']);
    Route::get('/get-leave-rti-details', [OperatorComplaintsController::class, 'fetchLeavesRtiDetails']);
    Route::get('/get-rti-details/{id}', [CommonController::class, 'fetchLeavesRtiDetailsById']);
      Route::post('/employement-management-login', [OperatorComplaintsController::class, 'checkPasswordForEmployeeManagement']);
    Route::post('/user-complaint-activity-log', [OperatorComplaintsController::class, 'userComplaintActivity']);

  
  });

  Route::middleware('role:supervisor:ds|js|us|ro-aro|ro|sec|cio-io|io|so|pro')->prefix('supervisor')->group(function () {
     
   //letter Records
    Route::get('/search-letter-record', [SupervisorLetterRecordsController::class, 'searchLetterRecords']);
    Route::post('/upload-letter-record', [SupervisorLetterRecordsController::class, 'uploadDocument']);
    Route::get('/get-letter-record/{id}', [SupervisorLetterRecordsController::class, 'getUploadDoc']);
    Route::get('/get-letter-doc/{id}', [SupervisorLetterRecordsController::class, 'getNoteLetterDocument']);
    Route::get('/view-letter-record/{id}', [SupervisorLetterRecordsController::class, 'getLetterRecord']);
    Route::get('/all-letters', [SupervisorLetterRecordsController::class, 'allLetters']);
    //     Route::get('/all-letters', [SupervisorLetterRecordsController::class, 'getAllLetters']);
    Route::get('/all-sent-letters', [SupervisorLetterRecordsController::class, 'getAllSendLetters']);
    Route::post('/approved-letter-by-rk/{id}', [SupervisorLetterRecordsController::class, 'approvedLetterByRk']);
    Route::post('/forward-letter-by-sec/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterBySec']);
    Route::post('/forward-letter-by-us/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterByus']);
    Route::post('/forward-letter-by-js/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterByjs']);
    Route::post('/forward-letter-by-ds/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterByds']);
    Route::post('/forward-letter-by-so/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterByso']);
    Route::post('/forward-letter-by-ro/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterByro']);
    Route::post('/forward-letter-by-aro/{complainId}', [SupervisorLetterRecordsController::class, 'forwardLetterByaro']);
    Route::get('/get-users-letter', [SupervisorLetterRecordsController::class, 'getUsers']);
    Route::post('/add-letter-notes', [SupervisorLetterRecordsController::class, 'addNotes']);
    Route::get('/get-letter-notes/{id}', [SupervisorLetterRecordsController::class, 'getNotes']);
    ...
    Route::post('/assign-permission', [UserManagement::class, 'assignPermission']);
    Route::get('/get-permission/{user_id}', [UserManagement::class, 'getUserPermissions']);
    Route::get('/get-all-modules', [UserManagement::class, 'getModules']);

    Route::get('/all-files', [EmployeesController::class, 'index']);
    Route::get('/all-files/{id}', [EmployeesController::class, 'fileDetails']);
    Route::get('/all-personal-files', [EmployeesController::class, 'viewPersonalFile']);
    Route::post('/update-personal-user-id', [EmployeesController::class, 'updatePersonUserId']);
    Route::post('/update-rti-user-id', [EmployeesController::class, 'updateRtiUserId']);
    ...
    Route::get('/get-leave-personal-details/{id}', [CommonController::class, 'fetchLeavesPersonalDetailsById']);
     Route::get('/get-leave-rti-details', [CommonController::class, 'fetchLeavesRtiDetails']);
     Route::get('/get-leave-rti-details/{id}', [CommonController::class, 'fetchLeavesRtiDetailsById']);
     Route::get('/get-user-rti-details', [CommonController::class, 'fetchUserRtiDetails']);
    ...
    Route::post('/upload-file', [EmployeesController::class, 'uploadFiles']);
    Route::post('/upload-private-file', [EmployeesController::class, 'uploadPrivateFiles']);
    Route::post('/store-private-file-authority', [EmployeesController::class, 'storePersonUserId']);
    ...
    Route::post('/add-notes-employee', [SupervisorComplaintsController::class, 'addNotesEmployee']);
    Route::get('note/{id}', [SupervisorComplaintsController::class, 'editNotes']);
    Route::put('notes/{id}', [SupervisorComplaintsController::class, 'updateNotes']);
    Route::post('/employement-management-login', [SupervisorComplaintsController::class, 'checkPasswordForEmployeeManagement']);
    Route::post('/user-complaint-activity-log', [SupervisorComplaintsController::class, 'userComplaintActivity']);


    Route::post('/personal-file-send', [EmployeesController::class, 'sendPersonalFile']);
    Route::post('/forward-file-send', [EmployeesController::class, 'forwardPersonalFile']);
    Route::post('/rti-file-send', [EmployeesController::class, 'forwardRtiFile']);

    //

    Route::post('/get-file-pages-count', [SupervisorCommonController::class, 'getPdfPages']);
    ...
    Route::post('assign-by-ro/{complainId}', [SupervisorComplaintsController::class, 'assignToRo']);
    ...
    Route::post('/upload-document-personal-file', [SupervisorComplaintsController::class, 'uploadDocumentPersonalFile']);
    ...
    Route::post('/forward-report-by-da/{complainId}', [SupervisorReportController::class, 'forwardReporttbyda']);
     ...
     Route::get('/search-request-complaint', [SupervisorReportController::class, 'search']);
    Route::post('/add-request-complaint', [SupervisorReportController::class, 'request_complaints']);
  ...
  Route::middleware('role:lok-ayukt')->prefix('lokayukt')->group(function () {
    ...
    Route::post('/assign-to-ps/{id}', [LokAyuktComplaintsController::class, 'assignToPs']);
    Route::get('/get-ps', [LokAyuktComplaintsController::class, 'getLokayuktPSUsers']);
    ...
    Route::get('/pendency-report', [LokAyuktReportController::class, 'pendencyReport']);
  ...
  Route::middleware('role:ps')->prefix('ps')->group(function () {
    ...
    Route::get('note/{id}', [PSComplaintsController::class, 'editNotes']);
    Route::put('notes/{id}', [PSComplaintsController::class, 'updateNotes']);
  ...
  Route::middleware('role:aps')->prefix('aps')->group(function () {
    Route::get('/all-files', [EmployeesController::class, 'index']);
    Route::get('/all-files/{id}', [EmployeesController::class, 'fileDetails']);
    ...
    Route::get('/all-district', [APSCommonController::class, 'fetch_district']);
    Route::get('/all-complaints', [APSComplaintsController::class, 'allComplains']);
    Route::get('/all-pending-complaints', [APSComplaintsController::class, 'allComplainspending']);
    Route::get('/all-approved-complaints', [APSComplaintsController::class, 'allComplainsapproved']);
    Route::get('/view-complaint/{id}', [APSComplaintsController::class, 'viewComplaint']);
    Route::post('/forward-by-so/{complainId}', [APSComplaintsController::class, 'forwardComplaintbySO']);
    Route::post('/dispose-complain/{complainId}', [APSComplaintsController::class, 'disposeComplaints']);
    Route::get('/get-lokayukt-uplokayukt', [APSComplaintsController::class, 'getUsers']);
    Route::get('/get-users', [APSComplaintsController::class, 'getSubROleUsers']);
    Route::get('/get-document/{id}', [APSComplaintsController::class, 'getUploadDoc']);
    Route::post('/upload-document', [APSComplaintsController::class, 'uploadDocument']);
    Route::get('/get-notes/{id}', [APSComplaintsController::class, 'getNotes']);
    Route::post('/add-notes', [APSComplaintsController::class, 'addNotes']);
    Route::get('/get-file-preview/{id}', [APSComplaintsController::class, 'getFilePreview']);
    Route::post('/return-complain-by-ps/{complainId}', [APSComplaintsController::class, 'returnComplainByPs']);
    Route::post('/pull-back-by-ps/{complainId}', [APSComplaintsController::class, 'pullBackByPs']);
    Route::post('forward-complain-by-ps/{complainId}', [APSComplaintsController::class, 'forwardComplaintbyAPS']);
      Route::post('assign-by-ps/{complainId}', [APSComplaintsController::class, 'assignToAPs']);
    Route::post('/fee-exempted/{complaint_id}', [APSComplaintsController::class, 'approvedFeeByPS']);
    Route::post('/forward-to-uplokayukt/{complaint_id}', [APSComplaintsController::class, 'approvedByupLokayukt']);
    Route::post('/reject-complaint-by-ps/{id}', [APSComplaintsController::class, 'rejectComplaintByPs']);
    // Route::post('/forward-by-ds-js/{complainId}',[APSComplaintsController::class,'forwardComplaintbyds']);
    // Route::post('/forward-by-da/{complainId}',[APSComplaintsController::class,'forwardComplaintbyda']);
    Route::post('/forward-by-ps/{complainId}', [APSComplaintsController::class, 'forwardComplaintbyPS']);
    Route::post('/request-report/{complainId}', [APSReportController::class, 'requestReport']);
    Route::get('/request-list/{complainId}', [APSReportController::class, 'requestReportList']);
    Route::get('/request-list-cio/{complainId}', [APSReportController::class, 'requestinvestigationReport']);
    /*
         * Forward Report By Subroles
         */
    Route::post('/forward-report-by-sec{complainId}', [APSReportController::class, 'forwardReporttbysec']);
    Route::post('/forward-report-by-cio/{complainId}', [APSReportController::class, 'forwardReporttbycio']);
    Route::post('/forward-report-by-da/{complainId}', [APSReportController::class, 'forwardReporttbyda']);

    Route::get('/get-lokayukt', [APSComplaintsController::class, 'getLokayuktUsers']);
    Route::get('/get-uplokayukt', [APSComplaintsController::class, 'getUpLokayuktUsers']);
    Route::get('/get-dealing-assistant', [APSComplaintsController::class, 'getDealingAssistantUsers']);
    Route::get('/progress-register', [APSReportController::class, 'progress_report']);
    Route::get('/complain-report', [APSReportController::class, 'complainReports']);
    Route::get('/current-report', [APSReportController::class, 'current_report']);
    Route::get('/analytic-report', [APSReportController::class, 'analytics']);
    // Route::get('/detail-by-complaintype',[LokAyuktReportController::class,'complainComplaintypeWise']);
    Route::get('/all-complains', [APSReportController::class, 'allComplains']);
    Route::get('/district-wise-complaint', [APSReportController::class, 'complainDistrictWise']);
    Route::get('/department-wise-complaint', [APSReportController::class, 'complainDepartmentWise']);
    Route::get('/montly-trends', [APSReportController::class, 'getMontlyTrends']);
    Route::get('/compliance-report', [APSReportController::class, 'complianceReport']);
    Route::get('/search-request-complaint', [APSReportController::class, 'search']);
    Route::post('/add-request-complaint', [APSReportController::class, 'request_complaints']);
   

    // // Daishboard
    Route::get('/dashboard/{date}', [APSDashboardController::class, 'index']);
    Route::get('/montly-complaint', [APSDashboardController::class, 'getDistrictGraph']);
    Route::get('/district-wise-company-type', [APSDashboardController::class, 'getdistrictWiseCompanyTypeGraph']);
    Route::get('/status-distribution', [APSDashboardController::class, 'gestatusDistribution']);
    // Route::get('/status-distribution',action: [SupervisorDashboardController::class,'gestatusDistribution']);
  ...
  Route::middleware('role:assistant-clerk,')->prefix('ac')->group(function () {
    Route::get('/all-files', [EmployeesController::class, 'index']);
    Route::get('/all-files/{id}', [EmployeesController::class, 'fileDetails']);
    ...
    Route::get('/all-district', [ACCommonController::class, 'fetch_district']);
    Route::get('/all-complaints', [ACComplaintsController::class, 'allComplains']);
    Route::get('/all-pending-complaints', [ACComplaintsController::class, 'allComplainspending']);
    Route::get('/all-approved-complaints', [ACComplaintsController::class, 'allComplainsapproved']);
    Route::get('/view-complaint/{id}', [ACComplaintsController::class, 'viewComplaint']);
    Route::post('/forward-by-so/{complainId}', [ACComplaintsController::class, 'forwardComplaintbySO']);
    Route::post('/dispose-complain/{complainId}', [ACComplaintsController::class, 'disposeComplaints']);
    Route::get('/get-lokayukt-uplokayukt', [ACComplaintsController::class, 'getUsers']);
    Route::get('/get-users', [ACComplaintsController::class, 'getSubROleUsers']);
    Route::get('/get-document/{id}', [ACComplaintsController::class, 'getUploadDoc']);
    Route::post('/upload-document', [ACComplaintsController::class, 'uploadDocument']);
    Route::get('/get-notes/{id}', [ACComplaintsController::class, 'getNotes']);
    Route::post('/add-notes', [ACComplaintsController::class, 'addNotes']);
    Route::get('/get-file-preview/{id}', [ACComplaintsController::class, 'getFilePreview']);
    Route::post('/return-complain-by-ps/{complainId}', [ACComplaintsController::class, 'returnComplainByPs']);
    Route::post('/pull-back-by-ps/{complainId}', [ACComplaintsController::class, 'pullBackByPs']);
    Route::post('forward-complain-by-ps/{complainId}', [ACComplaintsController::class, 'forwardComplaintbyPS']);
      Route::post('assign-by-aps/{complainId}', [ACComplaintsController::class, 'assignToAPs']);
    Route::post('/fee-exempted/{complaint_id}', [ACComplaintsController::class, 'approvedFeeByPS']);
    Route::post('/forward-to-uplokayukt/{complaint_id}', [ACComplaintsController::class, 'approvedByupLokayukt']);
    Route::post('/reject-complaint-by-ps/{id}', [ACComplaintsController::class, 'rejectComplaintByPs']);
    // Route::post('/forward-by-ds-js/{complainId}',[ACComplaintsController::class,'forwardComplaintbyds']);
    // Route::post('/forward-by-da/{complainId}',[ACComplaintsController::class,'forwardComplaintbyda']);
    Route::post('/forward-by-ps/{complainId}', [ACComplaintsController::class, 'forwardComplaintbyPS']);
    Route::post('/request-report/{complainId}', [ACReportController::class, 'requestReport']);
    Route::get('/request-list/{complainId}', [ACReportController::class, 'requestReportList']);
    Route::get('/request-list-cio/{complainId}', [ACReportController::class, 'requestinvestigationReport']);
    /*
         * Forward Report By Subroles
         */
    Route::post('/forward-report-by-sec{complainId}', [ACReportController::class, 'forwardReporttbysec']);
    Route::post('/forward-report-by-cio/{complainId}', [ACReportController::class, 'forwardReporttbycio']);
    Route::post('/forward-report-by-da/{complainId}', [ACReportController::class, 'forwardReporttbyda']);

    Route::get('/get-lokayukt', [ACComplaintsController::class, 'getLokayuktUsers']);
    Route::get('/get-uplokayukt', [ACComplaintsController::class, 'getUpLokayuktUsers']);
    Route::get('/get-dealing-assistant', [ACComplaintsController::class, 'getDealingAssistantUsers']);
    Route::get('/progress-register', [ACReportController::class, 'progress_report']);
    Route::get('/complain-report', [ACReportController::class, 'complainReports']);
    Route::get('/current-report', [ACReportController::class, 'current_report']);
    Route::get('/analytic-report', [ACReportController::class, 'analytics']);
    // Route::get('/detail-by-complaintype',[LokAyuktReportController::class,'complainComplaintypeWise']);
    Route::get('/all-complains', [ACReportController::class, 'allComplains']);
    Route::get('/district-wise-complaint', [ACReportController::class, 'complainDistrictWise']);
    Route::get('/department-wise-complaint', [ACReportController::class, 'complainDepartmentWise']);
    Route::get('/montly-trends', [ACReportController::class, 'getMontlyTrends']);
    Route::get('/compliance-report', [ACReportController::class, 'complianceReport']);
    Route::get('/search-request-complaint', [ACReportController::class, 'search']);
    Route::post('/add-request-complaint', [ACReportController::class, 'request_complaints']);
   

    // // Daishboard
    Route::get('/dashboard/{date}', [ACDashboardController::class, 'index']);
    Route::get('/montly-complaint', [ACDashboardController::class, 'getDistrictGraph']);
    Route::get('/district-wise-company-type', [ACDashboardController::class, 'getdistrictWiseCompanyTypeGraph']);
    Route::get('/status-distribution', [ACDashboardController::class, 'gestatusDistribution']);
    // Route::get('/status-distribution',action: [SupervisorDashboardController::class,'gestatusDistribution']);
  ...
  Route::middleware('role:steno')->prefix('st')->group(function () {
    Route::get('/all-files', [EmployeesController::class, 'index']);
    Route::get('/all-files/{id}', [EmployeesController::class, 'fileDetails']);
    ...
    Route::get('/all-district', [StenoCommonController::class, 'fetch_district']);
    Route::get('/all-complaints', [StenoComplaintsController::class, 'allComplains']);
    Route::get('/all-pending-complaints', [StenoComplaintsController::class, 'allComplainspending']);
    Route::get('/all-approved-complaints', [StenoComplaintsController::class, 'allComplainsapproved']);
    Route::get('/view-complaint/{id}', [StenoComplaintsController::class, 'viewComplaint']);
    Route::post('/forward-by-so/{complainId}', [StenoComplaintsController::class, 'forwardComplaintbySO']);
    Route::post('/dispose-complain/{complainId}', [StenoComplaintsController::class, 'disposeComplaints']);
    Route::get('/get-lokayukt-uplokayukt', [StenoComplaintsController::class, 'getUsers']);
    Route::get('/get-users', [StenoComplaintsController::class, 'getSubROleUsers']);
    Route::get('/get-document/{id}', [StenoComplaintsController::class, 'getUploadDoc']);
    Route::post('/upload-document', [StenoComplaintsController::class, 'uploadDocument']);
    Route::get('/get-notes/{id}', [StenoComplaintsController::class, 'getNotes']);
    Route::post('/add-notes', [StenoComplaintsController::class, 'addNotes']);
    Route::get('/get-file-preview/{id}', [StenoComplaintsController::class, 'getFilePreview']);
    Route::post('/return-complain-by-ps/{complainId}', [StenoComplaintsController::class, 'returnComplainByPs']);
    Route::post('/pull-back-by-ps/{complainId}', [StenoComplaintsController::class, 'pullBackByPs']);
    Route::post('forward-complain-by-ps/{complainId}', [StenoComplaintsController::class, 'forwardComplaintbyPS']);
      Route::post('assign-by-aps/{complainId}', [StenoComplaintsController::class, 'assignToAPs']);
    Route::post('/fee-exempted/{complaint_id}', [StenoComplaintsController::class, 'approvedFeeByPS']);
    Route::post('/forward-to-uplokayukt/{complaint_id}', [StenoComplaintsController::class, 'approvedByupLokayukt']);
    Route::post('/reject-complaint-by-ps/{id}', [StenoComplaintsController::class, 'rejectComplaintByPs']);
    // Route::post('/forward-by-ds-js/{complainId}',[StenoComplaintsController::class,'forwardComplaintbyds']);
    // Route::post('/forward-by-da/{complainId}',[StenoComplaintsController::class,'forwardComplaintbyda']);
    Route::post('/forward-by-ps/{complainId}', [StenoComplaintsController::class, 'forwardComplaintbyPS']);
    Route::post('/request-report/{complainId}', [StenoReportController::class, 'requestReport']);
    Route::get('/request-list/{complainId}', [StenoReportController::class, 'requestReportList']);
    Route::get('/request-list-cio/{complainId}', [StenoReportController::class, 'requestinvestigationReport']);
    /*
         * Forward Report By Subroles
         */
    Route::post('/forward-report-by-sec{complainId}', [StenoReportController::class, 'forwardReporttbysec']);
    Route::post('/forward-report-by-cio/{complainId}', [StenoReportController::class, 'forwardReporttbycio']);
    Route::post('/forward-report-by-da/{complainId}', [StenoReportController::class, 'forwardReporttbyda']);

    Route::get('/get-lokayukt', [StenoComplaintsController::class, 'getLokayuktUsers']);
    Route::get('/get-uplokayukt', [StenoComplaintsController::class, 'getUpLokayuktUsers']);
    Route::get('/get-dealing-assistant', [StenoComplaintsController::class, 'getDealingAssistantUsers']);
    Route::get('/progress-register', [StenoReportController::class, 'progress_report']);
    Route::get('/complain-report', [StenoReportController::class, 'complainReports']);
    Route::get('/current-report', [StenoReportController::class, 'current_report']);
    Route::get('/analytic-report', [StenoReportController::class, 'analytics']);
    // Route::get('/detail-by-complaintype',[LokAyuktReportController::class,'complainComplaintypeWise']);
    Route::get('/all-complains', [StenoReportController::class, 'allComplains']);
    Route::get('/district-wise-complaint', [StenoReportController::class, 'complainDistrictWise']);
    Route::get('/department-wise-complaint', [StenoReportController::class, 'complainDepartmentWise']);
    Route::get('/montly-trends', [StenoReportController::class, 'getMontlyTrends']);
    Route::get('/compliance-report', [StenoReportController::class, 'complianceReport']);
    Route::get('/search-request-complaint', [StenoReportController::class, 'search']);
    Route::post('/add-request-complaint', [StenoReportController::class, 'request_complaints']);
   

    // // Daishboard
    Route::get('/dashboard/{date}', [StenoDashboardController::class, 'index']);
    Route::get('/montly-complaint', [StenoDashboardController::class, 'getDistrictGraph']);
    Route::get('/district-wise-company-type', [StenoDashboardController::class, 'getdistrictWiseCompanyTypeGraph']);
    Route::get('/status-distribution', [StenoDashboardController::class, 'gestatusDistribution']);
    // Route::get('/status-distribution',action: [SupervisorDashboardController::class,'gestatusDistribution']);
  ...
  Route::middleware('role:dispatch')->prefix('dispatch')->group(function () {
    ...
    Route::post('/forward-file-send', [EmployeesController::class, 'forwardPersonalFile']);
    //RTI Files
    Route::get('/get-leave-rti-details', [DispatchCommonController::class, 'fetchLeavesRtiDetails']);
    Route::get('/get-leave-rti-details/{id}', [CommonController::class, 'fetchLeavesRtiDetailsById']);
    //Administrative Records
    Route::get('/search-letter-record', [DispatchLetterRecordsController::class, 'searchLetterRecords']);
    Route::post('/upload-letter-record', [DispatchLetterRecordsController::class, 'uploadDocument']);
    Route::get('/get-letter-record/{id}', [DispatchLetterRecordsController::class, 'getUploadDoc']);
    Route::get('/get-letter-doc/{id}', [DispatchLetterRecordsController::class, 'getNoteLetterDocument']);
    Route::get('/view-letter-record/{id}', [DispatchLetterRecordsController::class, 'getLetterRecord']);
    Route::get('/all-letters', [DispatchLetterRecordsController::class, 'allLetters']);
    //     Route::get('/all-letters', [DispatchLetterRecordsController::class, 'getAllLetters']);
    Route::get('/all-sent-letters', [DispatchLetterRecordsController::class, 'getAllSendLetters']);
    Route::post('/approved-letter-by-rk/{id}', [DispatchLetterRecordsController::class, 'approvedLetterByRk']);
    Route::post('/forward-letter-by-sec/{complainId}', [DispatchLetterRecordsController::class, 'forwardLetterBySec']);
    Route::post('/forward-letter-by-us/{complainId}', [DispatchLetterRecordsController::class, 'forwardLetterByus']);
    Route::post('/forward-letter-by-js/{complainId}', [DispatchLetterRecordsController::class, 'forwardLetterByjs']);
    Route::post('/forward-letter-by-ds/{complainId}', [DispatchLetterRecordsController::class, 'forwardLetterByds']);
    Route::post('/forward-letter-by-so/{complainId}', [DispatchLetterRecordsController::class, 'forwardLetterByso']);
    Route::get('/get-users-letter', [DispatchLetterRecordsController::class, 'getUsers']);
    Route::post('/add-letter-notes', [DispatchLetterRecordsController::class, 'addNotes']);
    Route::get('/get-letter-notes/{id}', [DispatchLetterRecordsController::class, 'getNotes']);
    ...
    Route::post('/add-rti-dispatch', [DispatchComplaintsController::class, 'addDispachRtilLeters']);
    Route::post('/add-personal-dispatch', [DispatchComplaintsController::class, 'addDispachPersonalLeters']);
    Route::get('/all-complain-ids', [DispatchComplaintsController::class, 'allComplainsId']);
//     Route::get('/all-rti-letter-ids', [DispatchComplaintsController::class, 'allDispatchRtiLettersId']);
//     Route::get('/all-rti-letter-ids', [EmployeesController::class, 'rtiFileIds']);
    Route::get('/all-dispatch-letters', [DispatchComplaintsController::class, 'allDispatchLetters']);
    Route::get('/all-dispatch-rti-letters', [DispatchComplaintsController::class, 'allDispatchRtiLetters']);
    Route::get('/all-dispatch-personal-letters', [DispatchComplaintsController::class, 'allDispatchPersonalLetters']);
     Route::get('/get-user-rti-details', [CommonController::class, 'fetchUserRtiDetails']);
     Route::get('/all-rti-letter-ids', [CommonController::class, 'fetchUserRtiDetailsIds']);

    // Route::post('/forward-by-ds-js/{complainId}',[StenoComplaintsController::class,'forwardComplaintbyds']);
    // Route::post('/forward-by-da/{complainId}',[APSComplaintsController::class,'forwardComplaintbyda']);
    Route::post('/forward-by-dispatch/{complainId}', [DispatchComplaintsController::class, 'forwardComplaintbyDispatch']);
    ...
    //23-03-2026
         Route::get('/get-roles-supervisors', [CommonController::class, 'getRolesSupervisors']);
    Route::get('/personal-file-list', [EmployeesController::class, 'personalFileList']);
    Route::get('/personal-file-id', [EmployeesController::class, 'personalFileIds']);
  ...
  Route::middleware('role:computer-assistant,car-driver,jamadar,orderly/jamadar,office,farrash,sweeper,gardener,cook,watchman,peon')->prefix('employee')->group(function () {
    Route::get('/all-files', [EmployeesController::class, 'index']);
    Route::get('/all-files/{id}', [EmployeesController::class, 'fileDetails']);
