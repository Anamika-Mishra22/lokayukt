...
class SupervisorLetterRecordsController extends Controller
{
    ...
    switch ($userSubrole) {
        ...
        case "so":
                ...
                // $q->where('rep.forward_to_so', $user)
            ...
            $q->where(function ($sub) use ($user) {
                $sub->where('rep.forward_to_so', $user)
                    ->where('approved_rejected_by_so', 0);
            })
            ...
            break;
              ...
              case "ds":
                ...
                $q->where(function ($sub) use ($user) {
                    $sub->where('rep.forward_to_ds', $user)
         ...
         case "js":
            ...
            $query->where(function ($q) use ($user) {
                ...
                $q->where(function ($sub) use ($user) {
                    $sub->where('rep.forward_to_js', $user)
                        ->where('approved_rejected_by_js', 0);
                })
            ...
            case "us":
                ...
                $q->where(function ($sub) use ($user) {
                    $sub->where('rep.forward_to_us', $user)
                        ->where('approved_rejected_by_us', 0);
                })
    ...
    //         ]);
        ...
        switch ($userSubrole) {
            ...
            //         });
             ...
             $query->where(function ($q) use ($user) {
                ...
                $q->where('rep.forward_by_ro', $user)
                    ->where('approved_rejected_by_ro', 1);
            ...
            case "ro-aro":
                ...
                $q->where('rep.forward_by_ro_aro', $user)
                    ->where('approved_rejected_by_ro_aro', 1);
            ...
            case "so":
                ...
                $query->where(function ($q) use ($user) {
                    ...
                    $q->where('rep.forward_by_ds', $user)
                    ->where('approved_rejected_by_ds', 1);
            ...
            case "js":
                ...
                $q->where('rep.forward_by_js', $user)
                    ->where('approved_rejected_by_js', 1);
                ...
                case "us":
                    ...
                    // });
                     $query->where(function ($q) use ($user) {
                        ...
                        $q->where('rep.forward_by_us', $user)
                            ->where('approved_rejected_by_us', 1);
            ...
            case "cio-io":
                ...
                $q->where('rep.forward_by_cio_io', $user)
                ...
                $q->where('rep.forward_by_io', $user)
        ...
        public function forwardLetterByaro(Request $request,$complainId){
            //    dd($complainId);
            // $user = Auth::user()->id;
            // dd($usersubrole);
