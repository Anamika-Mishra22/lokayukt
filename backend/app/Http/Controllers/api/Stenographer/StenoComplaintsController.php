...
namespace App\Http\Controllers\api\Stenographer;
...
class StenoComplaintsController extends Controller
{
...
//         'complaints.approved_rejected_by_st',
...
//                 ->where('rep.forward_to_st', $psId);
//         })

//         ->orWhere(function ($inner) {
//             $inner->where('complaints.approved_rejected_by_rk', 1)
//                 ->whereNull('complaints.approved_rejected_by_st');
//         });
...
//     //  ->where('complaints.approved_rejected_by_lokayukt', 1)
//     //       ->whereNotNull('rep.forward_to_st')
//     //       ->where('rep.forward_to_st', $user);
// $query->where('complaints.approved_rejected_by_rk', 1)
//     ->where('complaints.approved_rejected_by_lokayukt', 1)
//     // ->whereNotNull('rep.forward_to_st')
//     ->where(function ($q) use ($user, $parentId) {
//         $q->where('rep.forward_to_st', $user)
               ...
               if($cmp){
                ...
                // $cmp->remark = $remark;
                    ...
                    if($cmp->save()){
                         ...
                         $apcAction = new ComplaintAction();
                            $apcAction->complaint_id = $complainId;
                            $apcAction->forward_by_st = $userId;
...
// }
    ...
    //              if ($roleParent === 'lok-ayukt') {
    //                 $q->where('cm.approved_rejected_by_st','1')
    //                   ->where('rep.forward_by_st', $userId);
    ...
    //                     // ->toSql();
    //                     // ->where('approved_rejected_by_st', 1 )
    //                     ->distinct('cm.id')
    //                   ->get();
